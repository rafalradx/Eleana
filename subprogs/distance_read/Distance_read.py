...
""" Jak puszczam group processing z wciśniętym keep min max
    to przechodząc z CTPO do cw1 mówi że nie ma danych wewnątrz
    wybranego Range. Nawet jeśli range nie zostało zaznaczone"""
